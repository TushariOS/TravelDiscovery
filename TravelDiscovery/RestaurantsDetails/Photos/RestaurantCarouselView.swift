...
//  TravelDiscovery
//
//  Created by Tushar Jaunjalkar on 23/06/23.
//
...
struct RestaurantCarouselView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        let vc = RestaurantCarouselViewController(imageNames: imageNames, selectedIndex: selectedIndex)
        return vc
    }
...
class RestaurantCarouselViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
...
struct RestaurantCarouselView_Previews: PreviewProvider {
    static var previews: some View {
        RestaurantCarouselView(imageNames: ["https://letsbuildthatapp-videos.s3.us-west-2.amazonaws.com/7156c3c6-945e-4284-a796-915afdc158b5",
                                            "https://letsbuildthatapp-videos.s3-us-west-2.amazonaws.com/b1642068-5624-41cf-83f1-3f6dff8c1702",
                                            "https://letsbuildthatapp-videos.s3-us-west-2.amazonaws.com/6982cc9d-3104-4a54-98d7-45ee5d117531",
                                            "https://letsbuildthatapp-videos.s3-us-west-2.amazonaws.com/2240d474-2237-4cd3-9919-562cd1bb439e"], selectedIndex: 2)
    }
}
